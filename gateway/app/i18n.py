...
I18N_DICT: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tasks.wizard.page_title": "选择任务场景 - ShortVideo",
        "tasks.wizard.header_title": "选择任务场景",
        "tasks.wizard.header_subtitle": "请选择您要创建的任务类型",
        ...
        "tasks.scene.avatar.desc": "复刻真人形象，多语种口播。支持唇形同步。",
        ...
        "hot.follow.title": "热点跟拍",
        "hot.follow.subtitle": "参考视频拆解与复刻",
        "hot.follow.nav": "热点跟拍",
        "hot.follow.new.title": "热点跟拍 - 新建",
        "hot.follow.new.subtitle": "输入链接，生成热点跟拍任务",
        "hot.follow.new.form_title": "创建任务",
        "hot.follow.new.bgm_title": "BGM 设置",
        "hot.follow.new.bgm_replace": "替换原音",
        "hot.follow.new.bgm_keep": "保留原音",
        "hot.follow.new.bgm_mute": "静音",
        "hot.follow.new.bgm_mix": "BGM 混合比例 (0-1)",
        "hot.follow.new.cta": "创建并运行",
        "hot.follow.new.probe_title": "链接预览",
        "hot.follow.workbench.title": "热点跟拍 - 工作台",
        "hot.follow.workbench.subtitle": "任务进度与步骤控制",
        "hot.follow.workbench.pipeline_title": "流程步骤",
        "hot.follow.workbench.events_title": "事件记录",
        "hot.follow.workbench.cta": "返回工作台",
        "hot.follow.delivery.cta": "交付中心",
        "hot.follow.step.parse": "解析",
        "hot.follow.step.subtitles": "字幕",
        "hot.follow.step.dub": "配音",
        "hot.follow.step.pack": "打包",
        "hot.follow.step.scenes": "分镜",
        "hot.follow.action.parse": "重新解析",
        "hot.follow.action.subtitles": "重新字幕",
        "hot.follow.action.dub": "重新配音",
        "hot.follow.action.pack": "重新打包",
        "hot.follow.action.scenes": "生成分镜",
        "hot.follow.delivery.title": "热点跟拍 - 交付中心",
        "hot.follow.delivery.subtitle": "交付物下载与发布回填",
        "hot.follow.delivery.deliverables": "交付物",
        "hot.follow.delivery.empty": "暂无交付物。",
        "hot.follow.delivery.publish": "发布回填",
        "hot.follow.delivery.published_url": "发布链接",
        "hot.follow.delivery.notes": "备注",
        "hot.follow.delivery.notes.placeholder": "可选，记录发布渠道或说明",
        "hot.follow.delivery.publish_cta": "回填发布",
        ...
        "hot.follow.new.source_mode": "来源方式",
        "hot.follow.new.source_mode.link": "链接",
        "hot.follow.new.source_mode.local": "本地视频",
        "hot.follow.new.local_video": "本地视频",
        "hot.follow.new.local_video_hint": "支持 mp4 / mov / mkv，本地导入后继续进入 Hot Follow 工作台",
        "hot.follow.new.source_language": "源视频语言",
        "hot.follow.new.source_language.zh": "中文",
        "hot.follow.new.source_language.en": "English",
        ...
        "action.open": "打开",
        "action.open_detail": "进入详情",
        "action.download": "下载产物",
        "action.force_download": "强制下载",
        "action.download_disabled": "下载产物",
        "action.copy": "复制",
        "action.save": "保存",
        "action.submit": "提交",
        "action.unlock": "解锁",
        ...
        "tasks.filter.status.processing": "处理中",
        "tasks.filter.status.done": "已完成",
        "tasks.filter.status.attention": "需关注",
        "tasks.filter.scene.all": "全部场景",
        "tasks.filter.scene.avatar": "数字人",
        "tasks.filter.scene.hot_follow": "热点跟随",
        "tasks.filter.scene.baseline": "基础",
    ...
    "mm": {
        ...
        "tasks.wizard.page_title": "Choose a Task Scenario - ShortVideo",
        "tasks.wizard.header_title": "Choose a Task Scenario",
        "tasks.wizard.header_subtitle": "Select the type of task to create",
        ...
        "hot.follow.title": "Hot Follow",
        "hot.follow.subtitle": "Deconstruct and replicate trending videos",
        "hot.follow.nav": "Hot Follow",
        "hot.follow.new.title": "Hot Follow - New",
        "hot.follow.new.subtitle": "Paste a link to create a hot follow task",
        "hot.follow.new.form_title": "Create Task",
        "hot.follow.new.bgm_title": "BGM Settings",
        "hot.follow.new.bgm_replace": "Replace audio",
        "hot.follow.new.bgm_keep": "Keep original",
        "hot.follow.new.bgm_mute": "Mute",
        "hot.follow.new.bgm_mix": "BGM mix ratio (0-1)",
        "hot.follow.new.cta": "Create & Run",
        "hot.follow.new.probe_title": "Link Preview",
        "hot.follow.workbench.title": "Hot Follow - Workbench",
        "hot.follow.workbench.subtitle": "Track progress and control steps",
        "hot.follow.workbench.pipeline_title": "Pipeline Steps",
        "hot.follow.workbench.events_title": "Events",
        "hot.follow.workbench.cta": "Back to Workbench",
        "hot.follow.delivery.cta": "Delivery Center",
        "hot.follow.step.parse": "Parse",
        "hot.follow.step.subtitles": "Subtitles",
        "hot.follow.step.dub": "Dubbing",
        "hot.follow.step.pack": "Pack",
        "hot.follow.step.scenes": "Scenes",
        "hot.follow.action.parse": "Re-Parse",
        "hot.follow.action.subtitles": "Re-Subtitles",
        "hot.follow.action.dub": "Re-Dub",
        "hot.follow.action.pack": "Re-Pack",
        "hot.follow.action.scenes": "Generate Scenes",
        "hot.follow.delivery.title": "Hot Follow - Delivery Center",
        "hot.follow.delivery.subtitle": "Deliverables download and publish backfill",
        "hot.follow.delivery.deliverables": "Deliverables",
        "hot.follow.delivery.empty": "No deliverables yet.",
        "hot.follow.delivery.publish": "Publish Backfill",
        "hot.follow.delivery.published_url": "Published URL",
        "hot.follow.delivery.notes": "Notes",
        "hot.follow.delivery.notes.placeholder": "Optional notes",
        "hot.follow.delivery.publish_cta": "Backfill Publish",
        ...
        "hot.follow.new.source_mode": "ရင်းမြစ် ရွေးချယ်မှု",
        "hot.follow.new.source_mode.link": "လင့်ခ်",
        "hot.follow.new.source_mode.local": "ဒေသတွင်း ဗီဒီယို",
        "hot.follow.new.local_video": "ဒေသတွင်း ဗီဒီယို",
        "hot.follow.new.local_video_hint": "mp4 / mov / mkv ကို ပံ့ပိုးပြီး Hot Follow workbench သို့ ဆက်သွားမည်",
        "hot.follow.new.source_language": "မူရင်းဗီဒီယို ဘာသာစကား",
        "hot.follow.new.source_language.zh": "中文",
        "hot.follow.new.source_language.en": "English",
        ...
        "action.open": "ဖွင့်",
        "action.open_detail": "အသေးစိတ်ဝင်ရန်",
        "action.download": "ဒေါင်းလုဒ်",
        "action.force_download": "အတင်းဒေါင်းလုဒ်",
        "action.download_disabled": "ဒေါင်းလုဒ်",
        "action.copy": "ကူးယူ",
        ...
        "tasks.untitled": "အမည်မပါသော လုပ်ငန်း",
        "tasks.badge.pack_ready": "Pack Ready",
        "tasks.badge.pack_exists": "Pack Exists",
        "tasks.badge.video": "Video",
        "tasks.filter.status.all": "အခြေအနေအားလုံး",
        "tasks.filter.status.processing": "လုပ်ဆောင်နေ",
        "tasks.filter.status.done": "ပြီးဆုံး",
        "tasks.filter.status.attention": "အာရုံစိုက်ရန်",
        "tasks.filter.scene.all": "အခန်းအားလုံး",
        "tasks.filter.scene.avatar": "ဒစ်ဂျစ်တယ်လူ",
        "tasks.filter.scene.hot_follow": "ဟော့လိုက်",
        "tasks.filter.scene.baseline": "အခြေခံ",
