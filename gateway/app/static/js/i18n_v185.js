(function () {
  ...
  const CLIENT_DICT = {
    zh: {
      ...
      hot_follow_new_bgm_replace: "替换原音",
      hot_follow_new_bgm_keep: "保留原音",
      hot_follow_new_bgm_mute: "静音",
      hot_follow_new_bgm_mix_ratio: "BGM 混合比例 (0-1)",
      hot_follow_workbench_title: "热点跟拍 - 工作台",
      hot_follow_workbench_pipeline_title: "处理流水线",
      ...
      hot_follow_workbench_input_config: "输入配置",
  ...
  Object.assign(CLIENT_DICT.zh, {
    ...
    hot_follow_new_source_mode: "来源方式",
    hot_follow_new_source_mode_link: "链接",
    hot_follow_new_source_mode_local: "本地视频",
    hot_follow_new_local_video: "本地视频",
    hot_follow_new_local_video_hint: "支持 mp4 / mov / mkv，本地导入后继续进入 Hot Follow 工作台",
    hot_follow_new_source_language: "源视频语言",
    hot_follow_new_source_language_zh: "中文",
    hot_follow_new_source_language_en: "English",
    hot_follow_new_source_link_ph: "粘贴来源链接 (Douyin/XHS/TK/FB)",
    hot_follow_new_platform_auto: "自动识别",
    ...
    hot_follow_delivery_soft_subtitle_hint: "字幕可选：未生成时不影响主流程",
    ...
    hot_follow_publish_hashtags_placeholder: "输入 #tag",
    hot_follow_scene_pack_title: "场景切片",
    hot_follow_scene_pack_desc: "用于运营复用的场景切片。",
    hot_follow_scene_pack_generate: "生成 Scene Pack",
    hot_follow_scene_pack_download: "下载 Scenes.zip",
  ...
  Object.assign(CLIENT_DICT.mm, {
    ...
    hot_follow_new_source_mode: "ရင်းမြစ် ရွေးချယ်မှု",
    hot_follow_new_source_mode_link: "လင့်ခ်",
    hot_follow_new_source_mode_local: "ဒေသတွင်း ဗီဒီယို",
    hot_follow_new_local_video: "ဒေသတွင်း ဗီဒီယို",
    hot_follow_new_local_video_hint: "mp4 / mov / mkv ကို ပံ့ပိုးပြီး Hot Follow workbench သို့ ဆက်သွားမည်",
    hot_follow_new_source_language: "မူရင်းဗီဒီယို ဘာသာစကား",
    hot_follow_new_source_language_zh: "中文",
    hot_follow_new_source_language_en: "English",
    ...
    hot_follow_workbench_pipeline_title: "လုပ်ငန်းစဉ် ပိုင်းလိုင်း",
    hot_follow_workbench_parse: "ခွဲခြမ်းစိတ်ဖြာ",
    hot_follow_workbench_subtitles: "စာတန်းထိုး",
    hot_follow_workbench_dubbing: "အသံသွင်း",
    hot_follow_workbench_confirm_voiceover: "ပေါင်းစည်းရန် အဆင်သင့်ဖြစ်မှုအတွက် အသံသွင်းကို အတည်ပြုပါ",
    hot_follow_workbench_tts_engine: "TTS အင်ဂျင်",
    hot_follow_workbench_tts_voice: "TTS အသံ",
    hot_follow_workbench_tts_preview: "စမ်းနားထောင်",
    hot_follow_workbench_rerun_audio: "အသံပြန်ထုတ်",
    hot_follow_workbench_bgm_upload: "BGM တင်ရန်",
    hot_follow_workbench_bgm_mix: "BGM ရောနှောမှု",
    hot_follow_workbench_audio_fit_cap: "ပြောနှုန်းအမြင့်ဆုံး",
    hot_follow_workbench_audio_fit_cap_normal: "ပုံမှန် (1.25x)",
    hot_follow_workbench_audio_fit_cap_fast: "မြန် (2.0x)",
    hot_follow_workbench_audio_fit_cap_hint: "ပုံမှန်က သဘာဝကျ၊ မြန်က စာရှည်အတွက် သင့်တော်ပေမယ့် မြန်မြန်လို့ ခံစားနိုင်",
    ...
    hot_follow_workbench_overlay_target_subtitles: "ဘာသာပြန်စာတန်းကို ထပ်တင်",
    hot_follow_workbench_compose_confirm: "အသံ/ရောနှောမှု ဆက်တင်များ အဆင်သင့်ဖြစ်ကြောင်း အတည်ပြုသည်",
    ...
    hot_follow_delivery_hint_title: "ပို့ဆောင်မှု အညွှန်း",
    hot_follow_delivery_soft_subtitle_hint: "စာတန်းထိုး ရွေးချယ်နိုင်သည်—မရှိလည်း အဓိက လုပ်ငန်းစဉ် မထိခိုက်",
    hot_follow_publish_center: "ထုတ်ဝေစင်တာ",
    hot_follow_publish_feedback: "ပြန်တင်/ပြန်ဖြည့်",
    hot_follow_publish_link: "ထုတ်ဝေလင့်ခ်",
    hot_follow_publish_notes: "မှတ်ချက်",
    hot_follow_publish_submit: "ထုတ်ဝေမှု ပြန်ဖြည့်",
    hot_follow_publish_hashtags: "ဟက်ရှ်တက်",
    hot_follow_publish_hashtags_placeholder: "#tag ထည့်ပါ",
    hot_follow_delivery_open_workbench: "Workbench ဖွင့်",
    hot_follow_scene_pack_title: "မြင်ကွင်းခွဲ",
    hot_follow_scene_pack_desc: "လည်ပတ်ရေးအတွက် ပြန်သုံးနိုင်သော မြင်ကွင်းခွဲများ",
    hot_follow_scene_pack_generate: "မြင်ကွင်းခွဲ ဖန်တီး",
    hot_follow_scene_pack_download: "Scenes.zip ဒေါင်းလုပ်",
  ...
  Object.assign(CLIENT_DICT.en, {
    ...
    hot_follow_new_source_mode: "Source mode",
    hot_follow_new_source_mode_link: "Link",
    hot_follow_new_source_mode_local: "Local video",
    hot_follow_new_local_video: "Local video",
    hot_follow_new_local_video_hint: "Supports mp4 / mov / mkv and continues into the existing Hot Follow workbench",
    hot_follow_new_source_language: "Source video language",
    hot_follow_new_source_language_zh: "Chinese",
    hot_follow_new_source_language_en: "English",
    hot_follow_new_create_task: "Create Task",
    hot_follow_new_source_link: "Source Link",
    ...
    hot_follow_delivery_title: "Hot Follow - Delivery",
    hot_follow_delivery_hint_title: "Delivery Hint",
    hot_follow_delivery_soft_subtitle_hint: "Subtitles optional; not blocking main flow",
    ...
    hot_follow_publish_hashtags_placeholder: "Enter #tags",
    hot_follow_delivery_open_workbench: "Open Workbench",
    hot_follow_scene_pack_title: "Scene Pack",
    hot_follow_scene_pack_desc: "Reusable scene clips for operations",
    hot_follow_scene_pack_generate: "Generate Scene Pack",
    hot_follow_scene_pack_download: "Download Scenes.zip",
