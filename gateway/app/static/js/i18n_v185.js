(function () {
  ...
  const CLIENT_DICT = {
    zh: {
      ...
      hot_follow_workbench_source_label: "Original (Source)",
      hot_follow_workbench_target_label: "Target (Translated / Edited)",
      hot_follow_workbench_source_not_generated: "原文字幕尚未生成。",
      hot_follow_workbench_target_not_generated: "译文字幕尚未生成。",
      hot_follow_workbench_translation_cues_default: "Translation cues: - / -",
      hot_follow_workbench_translation_cues_prefix: "Translation cues",
      hot_follow_workbench_translation_mismatch: "Translation cues mismatch. Please refresh or re-run subtitles.",
    ...
    mm: {
      ...
      hot_follow_workbench_translation_cues_default: "Translation cues: - / -",
      hot_follow_workbench_translation_cues_prefix: "Translation cues",
      hot_follow_workbench_translation_mismatch: "Translation cues မကိုက်ညီပါ။ စာတန်းကို refresh လုပ်ပါ သို့မဟုတ် subtitles step ကို ပြန်လုပ်ပါ။",
      ...
      hot_follow_compose_reason_in_progress: "Compose လုပ်နေသည်…",
      hot_follow_compose_reason_failed: "Compose မအောင်မြင်ပါ၊ ပြန်ကြိုးစားနိုင်သည်",
      hot_follow_compose_reason_missing_voice: "အသံဖိုင် မရှိပါ",
      hot_follow_compose_reason_missing_raw: "မူရင်းဗီဒီယို မရှိပါ",
      hot_follow_compose_running: "Compose လုပ်နေသည်…",
