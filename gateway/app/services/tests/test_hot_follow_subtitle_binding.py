...
def test_url_empty_helper_pending_becomes_manual_fallback_required(monkeypatch):
    origin_srt = "1\n00:00:00,000 --> 00:00:02,000\nhello from source\n"
    ...
    assert lane["manual_target_subtitle_required"] is True
    assert lane["subtitle_ready_reason"] == "manual_target_subtitle_required"
    assert lane["target_subtitle_current_reason"] == "manual_target_subtitle_required"
    assert lane["dub_input_text"] == ""
