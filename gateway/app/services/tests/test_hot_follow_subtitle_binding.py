...
def test_manual_target_subtitle_save_writes_authority_owned_stage_truth(monkeypatch, tmp_path):
    task_id = "hf-manual-stage-truth"
    origin_srt = "1\n00:00:00,000 --> 00:00:02,000\n你好\n"
    target_srt = "1\n00:00:00,000 --> 00:00:02,000\nXin chao\n"
    uploads: list[tuple[str, str]] = []
    repo = _Repo(
    ...
    assert (tmp_path / task_id / "subs" / "vi.srt").read_text(encoding="utf-8") == target_srt
