...
def build_target_subtitle_translation_facts(
    *,
    ...
    facts = {
        ...
        "translation_execution_ref": _s(task.get("subtitle_translation_execution_ref")) or None,
        "helper_requested_at": _s(task.get("subtitle_translation_requested_at") or task.get("subtitle_helper_requested_at")) or None,
        "last_polled_at": _s(task.get("subtitle_translation_last_polled_at")) or None,
        "helper_responded_at": _s(task.get("subtitle_translation_output_received_at") or task.get("subtitle_helper_updated_at")) or None,
        "materialized_at": _s(task.get("subtitle_translation_materialized_at")) or None,
        "helper_failed_at": _s(task.get("subtitle_translation_failed_at") or task.get("subtitle_helper_failed_at")) or None,
        "retry_count": int(task.get("subtitle_translation_retry_count") or task.get("subtitle_helper_retry_count") or task.get("subtitle_retry_count") or 0),
