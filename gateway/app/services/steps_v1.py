...
from gateway.app.services.steps_text_support import (
    clean_text_for_dub as _svc_clean_text_for_dub,
    ensure_txt_from_srt as _svc_ensure_txt_from_srt,
    parse_srt_cues as _svc_parse_srt_cues,
    parse_srt_time as _svc_parse_srt_time,
    pick_mm_text_fallback as _svc_pick_mm_text_fallback,
    resolve_mm_txt_text as _svc_resolve_mm_txt_text,
    srt_to_txt as _svc_srt_to_txt,
    subtitle_result_contract as _svc_subtitle_result_contract,
)
...
def _srt_to_txt(srt_text: str) -> str:
    return _svc_srt_to_txt(srt_text)


def _ensure_txt_from_srt(dst_txt: Path, src_srt: Path) -> None:
    _svc_ensure_txt_from_srt(dst_txt, src_srt)
...
def _parse_srt_time(value: str) -> float:
    return _svc_parse_srt_time(value)


def _parse_srt_cues(srt_text: str) -> list[dict]:
    return _svc_parse_srt_cues(srt_text)
...
def _clean_text_for_dub(text: str) -> str:
    return _svc_clean_text_for_dub(text)
...
def _pick_mm_text_fallback(
    *,
    ...
    return _svc_pick_mm_text_fallback(
...
def _resolve_mm_txt_text(
    *,
    ...
    return _svc_resolve_mm_txt_text(
