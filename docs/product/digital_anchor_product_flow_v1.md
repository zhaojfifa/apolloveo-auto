# Digital Anchor Product-Flow Design v1 — 数字人口播产线设计（面向结果交付与契约重构）
...
> authority** for the Digital Anchor production line. Future Task Area /
> Workbench / Delivery Center implementations on the Digital Anchor line
> MUST map to the §5 / §6 / §7 modules below — task-area card fields
> (§5.2), workbench modules A / B / C / D / E (§6.1), delivery-center
> standard deliverables (§7.1) and delivery rules (§7.2) — not only to
> the packet / contract / runtime truth. "Operator-ready" cannot be
> claimed for Digital Anchor unless those modules are actually present
...
> specific concretization** of that flow for Digital Anchor. Where the
> two diverge for a Digital-Anchor-only concern, this document wins on
> Digital-Anchor surfaces.
>
> Authority chain:
...
> - Sibling line authority: `docs/product/matrix_script_product_flow_v1.md`
