...
- Coordinator (Jackie): `<fill>` — coordinator signoff binds OWC-DA Closeout row DA-A7, not gate opening.
- Product Manager: `<fill>` — product manager signoff binds OWC-DA Closeout row DA-A7, not gate opening.
