...
| Pre-trial operations addendum — post-OWC operational trial baseline (supersedes Plan A §6.2 MS + §6.3 DA + §7.1 samples; adds DA sample validity criteria + closure-store volatility protocol + DA final_video access path) | `docs/product/OPERATIONS_TRIAL_READINESS_POST_OWC_ADDENDUM_v1.md` (LANDED 2026-05-06) |
