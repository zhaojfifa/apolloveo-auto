...
| Trial re-entry review (separate review; merge precondition SATISFIED via PR [#141](https://github.com/zhaojfifa/apolloveo-auto/pull/141) / `27a5b6d`; opens only after explicit user hand-off lands — second precondition still binding) | (pending) |
